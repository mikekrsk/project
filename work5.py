...
class Pen(Stationery):
    def draw(self):
        print("Для тонкой работы - ", self.title)


class Pencil(Stationery):
    def draw(self):
        print("Для цветной работы - ", self.title)


class Handle(Stationery):
    def draw(self):
        print("Жирненько обведи маркером - ", self.title)


atrpen = Pen("Карандаш")
atrpencil = Pencil("Ручка")
atrhandle = Handle("Маркер")
